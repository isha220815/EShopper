                ...
                <div class="contact-form">
                   <!--  <div id="success"></div> -->
                    <form action="reg" method="post" >
                        ...
                        <div class="control-group">
                            <input type="text" name="mob" class="form-control" id="subject" placeholder="Your Mobile Number"
                                required="required" data-validation-required-message="Please enter a subject" />
                            <p class="help-block text-danger"></p>
                        </div>
                         <div class="control-group">
                            <input type="text" name="cadd" class="form-control" id="subject" placeholder="Your Address"
                                required="required" data-validation-required-message="Please enter a subject" />
                            <p class="help-block text-danger"></p>
                        </div>
                         <div class="control-group">
                            <input type="text" name="unm" class="form-control" id="subject" placeholder="Enter Usename"
                                required="required" data-validation-required-message="Please enter a subject" />
                            <p class="help-block text-danger"></p>
                        </div>
                         <div class="control-group">
                            <input type="password" name="pw" class="form-control" id="subject" placeholder="Enter password"
                                required="required" data-validation-required-message="Please enter a subject" />
                            <p class="help-block text-danger"></p>
                        </div>
